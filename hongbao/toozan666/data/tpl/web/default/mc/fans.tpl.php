					...
					<tr>
						...
						<td>
							...
							<div class="fans-tag-area">
								<span class="tag-list get-fans-tag js-group" data-id="<?php  echo $fan['fanid'];?>" data-toggle='popover'>
...
<script>
	...
	$(function(){
		...
		$(".put-group").popover({
			placement : 'bottom',
			html : true,
			template : '<div class="popover we7-popover" role="tooltip" data-toggle="popover"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content" ></div></div>',
			content : '' +
			'<div class="we7-form">' +
