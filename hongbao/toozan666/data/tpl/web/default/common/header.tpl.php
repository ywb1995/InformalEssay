	...
	<div class="panel-body clearfix main-panel-body <?php  if(!empty($_W['setting']['copyright']['leftmenufixed'])) { ?>menu-fixed<?php  } ?>">
		<div class="left-menu">
			...
			<div class="left-menu-content">
				...
				<?php  if(($frame_section['title'] == '配置' || $frame_section['title'] == '应用模块')) { ?>
				<?php  continue;?>
				<?php  } ?>
				...
				<div class="panel panel-menu">
					...
					<ul class="list-group">
						<?php  if(is_array($frame_section['menu'])) { foreach($frame_section['menu'] as $menu_id => $menu) { ?>
							<?php  if(($menu['title'] == '微官网-文章' || $menu['title'] == '会员管理')) { ?>
						<?php  continue;?>
							<?php  } ?>
							...
							<?php  } ?>
						<?php  } } ?>
						<?php  if(($frame_section['title'] == '粉丝')) { ?>
							<li class="list-group-item ">
							<a href="./index.php?c=mc&a=hongbao&" class="text-over" >
						...
						<li class="list-group-item ">
							<a href="./index.php?c=mc&a=hongbao&do=classtype&type=1" class="text-over" >
							<i class="wi wi-fansmanage"></i>
							已领取红包
							</a>
						</li>
						...
						<li class="list-group-item ">
							<a href="./index.php?c=mc&a=hongbao&do=classtype&type=0" class="text-over" >
							<i class="wi wi-fansmanage"></i>
							未领取红包
							</a>
						</li>
						...
						<li class="list-group-item ">
							<a href="./index.php?c=mc&a=hongbao&do=classtype&type=2" class="text-over" >
							<i class="wi wi-fansmanage"></i>
							发送失败红包
							</a>
						</li>
						...
						<li class="list-group-item ">
							<a href="./index.php?c=mc&a=hongbao&do=hongbaouser" class="text-over" >
							<i class="wi wi-fansmanage"></i>
							用户领取信息
							</a>
						</li>
